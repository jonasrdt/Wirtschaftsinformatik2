    ...
    for versuch in range(1,4): 
        ...
        while not gueltige_eingabe:
            try:
                ...
                print("Das ist aber keine Zahl! Bitte geben Sie eine Zahl ein.")
        ...
        if entscheidung == "a":
            if tipp == loesungAddition:
                ...
                # Wenn die Nutzereingabe keine Zeichenkette ist, dann wird die Frage noch mal gestellt
                weiterspielen_gueltig = False
                while not weiterspielen_gueltig:
                    try:
                        spielen = input("Wollen Sie weiterspielen? ")
                        weiterspielen_gueltig = True
                    except:
